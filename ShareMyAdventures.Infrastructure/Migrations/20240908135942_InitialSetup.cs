    ...
    public partial class InitialSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessLevelLookups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvitationStatusLookups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EllipsoidalAltitude = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FriendListId = table.Column<long>(type: "bigint", nullable: false),
                    FriendsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendListParticipant", x => new { x.FriendListId, x.FriendsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendListParticipant_FriendLists_FriendListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friends_InvitationStatusLookups_InvitationStatusLookupId",
                        column: x => x.InvitationStatusLookupId,
                        principalTable: "InvitationStatusLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Adventures_StatusLookups_StatusLookupId",
                        column: x => x.StatusLookupId,
                        principalTable: "StatusLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Adventures_TypeLookups_TypeLookupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdventureInvitations_AccessLevelLookups_AccessLevelLookupId",
                        column: x => x.AccessLevelLookupId,
                        principalTable: "AccessLevelLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdventureInvitations_InvitationStatusLookups_InvitationStatusLookupId",
                        column: x => x.InvitationStatusLookupId,
                        principalTable: "InvitationStatusLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParticipantAdventures_AccessLevelLookups_AccessLevelLookupId",
                        column: x => x.AccessLevelLookupId,
                        principalTable: "AccessLevelLookups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessLevelLookups_Name",
                table: "AccessLevelLookups",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AdventureInvitations_AccessLevelLookupId",
                table: "AdventureInvitations",
                column: "AccessLevelLookupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdventureInvitations_InvitationStatusLookupId",
                table: "AdventureInvitations",
                column: "InvitationStatusLookupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adventures_StatusLookupId",
                table: "Adventures",
                column: "StatusLookupId");

            migrationBuilder.CreateIndex(
                name: "IX_Adventures_TypeLookupId",
                table: "Adventures",
                column: "TypeLookupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_InvitationStatusLookupId",
                table: "Friends",
                column: "InvitationStatusLookupId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Friends",
                columns: ["ParticipantFriendId", "ParticipantId"],
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvitationStatusLookups_Name",
                table: "InvitationStatusLookups",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParticipantAdventures_AccessLevelLookupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusLookups_Name",
                table: "StatusLookups",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TypeLookups_Name",
                table: "TypeLookups",
                column: "Name",
                unique: true);
        }
